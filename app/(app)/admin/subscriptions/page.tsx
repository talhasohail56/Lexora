  ...
  return (
    <PageTransition>
      ...
      <GlowCard className="overflow-hidden p-0">
        <div className="grid grid-cols-[1.2fr_0.8fr_0.8fr_0.8fr_0.8fr] border-b bg-muted/40 px-5 py-3 text-xs font-semibold uppercase tracking-wider text-muted-foreground">
          <span>User</span>
          <span>Role</span>
          <span>Plan</span>
          <span>Status</span>
        ...
        {rows.map((row) => (
          <div key={row.id} className="grid grid-cols-[1.2fr_0.8fr_0.8fr_0.8fr_0.8fr] items-center border-b px-5 py-4 text-sm last:border-b-0">
            <div>
